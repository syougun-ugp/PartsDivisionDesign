...
public:
	...
	void Translate(const Vector2& position){ this->position += position; }
	void Scaling(const Vector2& scale){ this->scale += scale; }
	void Rotation(const Vector2& rotation){ this->rotation += rotation; }
